...
var BTN_BLOCK = document.querySelector(".product-description__control-block"),
    BTNS = BTN_BLOCK.children,
    MAIN_WIDTH = document.documentElement.clientWidth;
BTN_BLOCK.addEventListener("touchstart", handleTouchStart, !1), BTN_BLOCK.addEventListener("touchmove", handleTouchMove, !1);
var xDown = null;
  ...
  if (xDown - t > 0) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        var _e8 = _step.value;
        _e8.style.transform = MAIN_WIDTH < 400 ? "translateX(-270px)" : "translateX(-200px)";
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
