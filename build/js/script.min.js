...
testWebP(function (e) {
  ...
  var e = document.querySelector(".feedback__send-btn"),
      ...
      r = document.querySelectorAll(".feed-window__column-one input"),
      o = r[0],
      c = r[1],
      d = r[2],
      s = document.querySelector(".feed-window__column-two textarea"),
      u = document.querySelectorAll(".feed-window__rate img");
  ...
  function m() {
    o.value = "", c.value = "", d.value = "", s.value = "", function () {
      for (var _e2 = 0; _e2 < u.length; _e2++) {
        u[_e2].setAttribute("src", "./img/empty.png"), u[_e2].previousElementSibling.setAttribute("srcset", "./img/empty.webp"), u[_e2].setAttribute("width", "28"), u[_e2].setAttribute("height", "28");
      }
    }(), a();
  }
  ...
  var e = document.querySelectorAll(".feed-window__column-one input"),
      ...
      r = document.querySelectorAll(".feed-window__rate img"),
      o = document.querySelector(".feed-window__send-btn"),
      c = document.querySelector(".feedback"),
      d = document.querySelector(".feedback__block"),
      s = document.querySelector(".feedback__modarate-message");
  var u = [{
    id: -1,
    name: "Борис Иванов",
  ...
  var _loop3 = function _loop3(_e3) {
    r[_e3].addEventListener("click", function () {
      a(event, _e3);
    });
  };
  ...
  function m(e) {
    var t = d.cloneNode(!0),
        ...
        o = t.children[4],
        u = t.children[5].children[1],
        a = t.children[6].children[1],
        m = t.children[6].children[2];
    t.classList.remove("feedback__block-hidden"), t.setAttribute("data-id", e.id), n.textContent = e.name, i.textContent = e.plus, l.textContent = e.minus, r.textContent = e.comment, o.append(function (e) {
      var t = e,
      ...
      for (var _e4 = 0; _e4 < 5; _e4++) {
        ...
        _i.setAttribute("type", "image/webp"), _l.setAttribute("alt", "star"), _l.setAttribute("width", "28"), _l.setAttribute("height", "28"), _l.classList.add("feedback__red-star"), t >= 1 ? (_i.setAttribute("srcset", "./img/full.webp"), _l.setAttribute("src", "./img/full.png"), _l.setAttribute("width", "28"), _l.setAttribute("height", "28"), t -= 1) : .5 == t ? (_i.setAttribute("srcset", "./img/half.webp"), _l.setAttribute("src", "./img/half.png"), _l.setAttribute("width", "28"), _l.setAttribute("height", "28"), t -= 1) : (_i.setAttribute("srcset", "./img/empty.webp"), _l.setAttribute("src", "./img/empty.png"), _l.setAttribute("width", "28"), _l.setAttribute("height", "28")), _e5.append(_i), _e5.append(_l), n.append(_e5);
      }
    ...
    }(e.rate)), u.addEventListener("click", function () {
      !function (e) {
      ...
      !function (e) {
        ...
        "" == t.value ? t.style.border = "2px solid red" : (t.style.border = "1px solid black", t.value = "", p(e), s.style.display = "flex", setTimeout(function () {
  ...
  function b(e) {
    ...
    for (var _n4 = 3; _n4 < c.children.length; _n4++) {
      null != e.id && c.children[_n4].getAttribute("data-id") == e.id && (t = !0);
    }
  ...
  !function () {
    for (var _e7 = 0; _e7 < u.length; _e7++) {
      m(u[_e7]);
    }
    ...
    (function () {
      ...
      "" == t.value && "" == l.value ? (e = !1, c(t, n, r, "visible"), c(l, n, o, "visible")) : "" == t.value ? (e = !1, c(t, n, r, "visible"), c(l, i, o, "hidden")) : "" == l.value ? (e = !1, c(l, n, o, "visible"), c(t, i, r, "hidden")) : (e = !0, c(t, i, r, "hidden"), c(l, i, o, "hidden"));
      ...
      var e = function () {
        ...
        return e.id = localStorage.length + 1, e.name = t.value, e.plus = n.value, e.minus = i.value, e.comment = l.value, e.rate = function () {
          ...
          for (var _t5 = 0; _t5 < r.length; _t5++) {
            e += Number(r[_t5].getAttribute("data-rate"));
          }
    ...
    }(), f(), window.modal.cleanFormAfterSendFunc());
  });
}(), console;