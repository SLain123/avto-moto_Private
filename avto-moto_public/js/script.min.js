...
function createFeedbackBlock(e) {
  var t = feedbackPattern.cloneNode(!0),
      ...
      o = t.children[4],
      d = t.children[5].children[1];
  t.classList.remove("feedback__block-hidden"), t.setAttribute("data-id", e.id), n.innerHTML = e.name, l.innerHTML = e.plus, a.innerHTML = e.minus, i.innerHTML = e.comment, o.append(generateRate(e.rate)), d.addEventListener("click", function () {
...
function expandAnswerBlock(e) {
  var t = e.target.parentElement.nextElementSibling,
      ...
      a = e.target.parentElement.nextElementSibling.children[1],
      i = e.target.parentElement.nextElementSibling.children[0];
  t.style.animationName = "expandAnswer", t.style.animationPlayState = "running", t.style.display = "block", i.style.border = "1px solid black", l.addEventListener("click", function () {
    hideAnswerBlock(e);
