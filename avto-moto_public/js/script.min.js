...
function addStar(e, t) {
  ...
  !function (e) {
    for (var _t = 0; _t < rateStars.length; _t++) {
      _t < e ? l(rateStars[_t]) : _t > e && a(rateStars[_t]);
    }
...
function createFeedbackBlock(e) {
  var t = feedbackPattern.cloneNode(!0),
      ...
      a = t.children[2].children[2],
      i = t.children[3].children[1],
      o = t.children[4];
  t.classList.remove("feedback__block-hidden"), t.setAttribute("data-id", e.id), n.innerHTML = e.name, l.innerHTML = e.plus, a.innerHTML = e.minus, i.innerHTML = e.comment, o.append(generateRate(e.rate)), feedbackMainBlock.append(t);
}
...
function checkId(e) {
  ...
  for (var n = 3; n < feedbackMainBlock.children.length; n++) {
    feedbackMainBlock.children[n].getAttribute("data-id") == e.id && (t = !0);
  }
...
function generateRate(e) {
  ...
  for (var _e6 = 0; _e6 < 5; _e6++) {
    ...
    l.setAttribute("type", "image/webp"), a.setAttribute("alt", "star"), a.classList.add("feedback__red-star"), t >= 1 ? (l.setAttribute("srcset", "./img/full.webp"), a.setAttribute("src", "./img/full.png"), t -= 1) : .5 == t ? (l.setAttribute("srcset", "./img/half.webp"), a.setAttribute("src", "./img/half.png"), t -= 1) : (l.setAttribute("srcset", "./img/empty.webp"), a.setAttribute("src", "./img/empty.png")), _e7.append(l), _e7.append(a), n.append(_e7);
  }
...
addDefaultBlockToWeb(), addNewFeedback(), feedSendBtn.addEventListener("click", function () {
  addDataToLocalStorage(), addNewFeedback(), cleanFormAfterSend();
});
...
for (var _e8 = 0; _e8 < mainAnswerBtn.length; _e8++) {
  mainAnswerBtn[_e8].addEventListener("click", expandAnswerBlock);
}

for (var _e9 = 0; _e9 < closeAnswerBtn.length; _e9++) {
  closeAnswerBtn[_e9].addEventListener("click", hideAnswerBlock);
}

for (var _e10 = 0; _e10 < sendAnswerBtn.length; _e10++) {
  sendAnswerBtn[_e10].addEventListener("click", saveAnswer);
}

function expandAnswerBlock(e) {
  var t = e.target.parentElement.nextElementSibling,
      n = t.querySelector(".feedback__answer-btn");
  t.style.animationName = "expandAnswer", t.style.animationPlayState = "running", t.style.display = "block", setTimeout(function () {
...
function hideAnswerBlock() {
  var e = event.target.parentElement.parentElement.parentElement,
      t = e.querySelector(".feedback__answer-btn");
  e.style.animationName = "hideAnswer", e.style.animationPlayState = "running", t.style.visibility = "hidden", setTimeout(function () {
