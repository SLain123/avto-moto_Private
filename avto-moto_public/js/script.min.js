...
function checkTarget(e) {
  e.target != modalFeedbackWindow && (hideModalWindow(), cleanFormAfterSend());
}

feedbackOpenBtn.addEventListener("click", displayModalWindow), feedbackCloseBtn.addEventListener("click", function () {
  hideModalWindow(), cleanFormAfterSend();
}), modalBackground.addEventListener("click", checkTarget), document.addEventListener("keydown", function () {
...
function cleanFormAfterSend() {
  feedName.value = "", feedPlus.value = "", feedMinus.value = "", feedComment.value = "", function () {
    for (var _e5 = 0; _e5 < rateStars.length; _e5++) {
      rateStars[_e5].setAttribute("src", "./img/empty.png"), rateStars[_e5].previousElementSibling.setAttribute("srcset", "./img/empty.webp");
    }
  }(), hideModalWindow();
}
...
function generateRate(e) {
  ...
  for (var _e7 = 0; _e7 < 5; _e7++) {
    ...
    l.setAttribute("type", "image/webp"), i.setAttribute("alt", "star"), i.classList.add("feedback__red-star"), t >= 1 ? (l.setAttribute("srcset", "./img/full.webp"), i.setAttribute("src", "./img/full.png"), t -= 1) : .5 == t ? (l.setAttribute("srcset", "./img/half.webp"), i.setAttribute("src", "./img/half.png"), t -= 1) : (l.setAttribute("srcset", "./img/empty.webp"), i.setAttribute("src", "./img/empty.png")), _e8.append(l), _e8.append(i), n.append(_e8);
  }
